...
async function loadMobileOnly(baseUrl) {
  ...
  // Verify integrity against meta.files BEFORE parsing - this is the check
  // createRuPhoneBaseFromData itself can't do, since by the time you call it
  // the raw bytes are already gone (turned into parsed objects).
